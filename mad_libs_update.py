...
def choose_level():
    ...
    questions with.
    '''
#Feedback in my last review was that I should remove magic numbers from my code.
#I have attempted to do so by assigning values below to easy, medium and hard.
#Have I placed these in the right position and is there a need for the return
#in line 54,57,60.
...
#Feedback in my last review was that I should remove magic numbers from my code.
#I have attempted to do so by assigning values below to hard_level_index etc

    level = choose_level()
    hard_level_index=3
    medium_level_index=2
    while level < hard_level_index:
        play_game(level)

        # If we're at easy or medium, prompt to advance
        if level < medium_level_index:
            proceed = raw_input(
